...
class SentenceSuite extends FunSuite with Utilities {
  ...
  val numberParser = new NumberParser {
    override def parse(text: String): Double = text match {
      case "1000"                      => 1000.0
      case "two million" | "2 million" => 2000000.0
    }
  }
  ...
  def test(sentence: String,
    ...
    test(testName) {
      ...
      for ((expectedNode, (variable, expectedQueryString, ordering)) <- expectedNodes
             .zip(expectedQueries)) {
        val actualQuery = compileSparqlQuery(expectedNode, env)
        val expectedQuery =
          parseSparqlQuery(variable, expectedQueryString, ordering)
  ...
  test(
    "who/WP/who acted/VBD/act in/IN/in Alien/NNP/alien",
  ...
  test(
    "who/WP/who starred/VBD/star in/IN/in Inception/NNP/inception",
  ...
  test(
    "Movies/NNP/movie starring/VB/star Winona/NNP/winona Ryder/NNP/ryder",
  ...
  test(
    "In/IN/in what/WDT/what movies/NN/movie did/VBD/do Jennifer/NNP/jennifer Aniston/NNP/aniston appear/VB/appear",
  ...
  test(
    "who/WP/who are/VBP/be the/DT/the actors/NNS/actor "
  ...
  test(
    "who/WP/who directed/VBD/direct Pocahontas/NNP/pocahontas",
  ...
  test(
    "Who/WP/who did/VBD/do Bill/NNP/bill Clinton/NNP/clinton marry/VB/marry",
  ...
  test(
    "which/WDT/which mountains/NNS/mountain are/VBP/be 1000/CD/1000 meters/NNS/meter high/JJ/high",
  ...
  test(
    "authors/NNS/author which/WDT/which died/VBD/die in/IN/in Berlin/NNP/berlin",
  ...
  test(
    "authors/NNS/author which/WDT/which were/VBD/be born/VBD/bear in/IN/in Berlin/NNP/berlin"
  ...
  test(
    "who/WP/who was/VBD/be born/VBD/bear in/IN/in Berlin/NNP/berlin or/CC/or died/VBD/die in/IN/in Paris/NNP/paris",
  ...
  test(
    "Which/WDT/which presidents/NNS/president were/VBD/be born/VBN/bear before/IN/before 1900/CD/1900",
  ...
  test(
    "Give/VB/give me/PRP/me all/DT/all actors/NNS/actor born/VBN/bear"
  ...
  test(
    "Which/WDT/which movies/NNS/movie "
    ...
    { env =>
      ...
      List(
        movie
          .and(
            (out(P.hasFilmingLocation, germany)
              .and(out(P.hasFilmingLocation, denmark)))
  ...
  test(
    "Give/VB/give me/PRP/me all/DT/all musicians/NNS/musician that/WDT/that were/VBD/be born/VBN/bear"
  ...
  test(
    "Which/WDT/which books/NN/book did/VBD/do George/NNP/george Orwell/NNP/orwell write/VB/write",
  ...
  test(
    "list/VB/list presidents/NNS/president of/IN/of Argentina/NNP/argentina",
  ...
  test(
    "List/VB/list albums/NNS/album of/IN/of Pink/NNP/pink Floyd/NNP/floyd",
  ...
  test(
    "List/VB/list the/DT/the actors/NNS/actor of/IN/of Titanic/NNP/titanic",
  ...
  test(
    "Who/WP/who is/VBZ/be the/DT/the director/NN/director of/IN/of Big/NN/big Fish/NN/fish",
    // ListQuestion(RelationshipQuery(NamedQuery(List(Token("the", "DT", "the"),
  ...
  test(
    "What/WP/what are/VBP/be the/DT/the members/NNS/member of/IN/of Metallica/NNP/metallica",
    // ListQuestion(RelationshipQuery(NamedQuery(List(Token("the", "DT", "the"),
  ...
  test(
    "members/NNS/member of/IN/of Metallica/NNP/metallica",
  ...
  test(
    "What/WP/what is/VBZ/be the/DT/the music/NN/music genre/NN/genre of/IN/of Gorillaz/NNP/gorillaz",
    // ListQuestion(RelationshipQuery(NamedQuery(List(Token("the", "DT", "the"),
  ...
  test(
    "What/WP/what is/VBZ/be the/DT/the cast/NN/cast of/IN/of Friends/NNS/friend",
  ...
  test(
    "who/WP/who are/VBP/be the/DT/the children/NNS/child of/IN/of the/DT/the presidents/NNS/president",
    // ListQuestion(RelationshipQuery(NamedQuery(List(Token("the", "DT", "the"),
  ...
  test(
    "what/WP/what are/VBP/be the/DT/the population/NN/population sizes/NNS/size"
  ...
  test(
    "Who/WP/who are/VBP/be the/DT/the children/NNS/child of/IN/of the/DT/the children/NNS/child"
  ...
  test(
    "Clinton/NNP/clinton 's/POS/'s daughters/NN/daughter",
  ...
  test(
    "What/WP/what are/VBP/be the/DT/the largest/JJS/large cities/NNS/city of/IN/of California/NNP/california",
    // ListQuestion(RelationshipQuery(NamedQuery(List(Token("the", "DT", "the"),
  ...
  test(
    "What/WP/what are/VBP/be the/DT/the biggest/JJS/big cities/NNS/city"
  ...
  test(
    "What/WP/what are/VBP/be California/NNP/california 's/POS/'s"
  ...
  test(
    "Who/WP/who is/VBZ/be Bill/NNP/bill Clinton/NNP/clinton 's/POS/'s daughter/NN/daughter",
  ...
  test(
    "Who/WP/who is/VBZ/be Bill/NNP/bill Clinton/NNP/clinton 's/POS/'s daughter/NN/daughter 's/POS/'s"
  ...
  test(
    "Who/WP/who are/VBP/be the/DT/the daughters/NNS/daughter of/IN/of the/DT/the wife/NN/wife of/IN/of"
  ...
  test(
    "Who/WP/who is/VBZ/be the/DT/the son/NN/son of/IN/of the/DT/the actor/NN/actor of/IN/of"
  ...
  test(
    "children/NNS/child of/IN/of all/DT/all presidents/NNS/president of/IN/of the/DT/the US/NNP/us",
  ...
  test(
    "List/VB/list movies/NNS/movie directed/VBN/direct by/IN/by Quentin/NNP/quentin Tarantino/NNP/tarantino",
    // ListQuestion(QueryWithProperty(NamedQuery(List(Token("movies", "NNS", "movie"))),
  ...
  test(
    "Which/WDT/which movies/NN/movie did/VBD/do Mel/NNP/mel Gibson/NNP/gibson direct/VB/direct",
    // ListQuestion(QueryWithProperty(NamedQuery(List(Token("movies", "NN", "movie"))),
  ...
  test(
    "what/WDT/what languages/NNS/language are/VBP/be spoken/VBN/speak in/IN/in Switzerland/NNP/switzerland",
  ...
  test(
    "Which/WDT/which books/NN/book did/VBD/do Orwell/NNP/orwell or/CC/or Shakespeare/NNP/shakespeare write/VB/write",
    // ListQuestion(QueryWithProperty(NamedQuery(List(Token("books", "NN", "book"))),
    //   InversePropertyWithFilter(List(Token("did", "VBD", "do"), Token("write", "VB", "write")),
  ...
  test(
    "which/WDT/which books/NN/book were/VBD/be authored/VBN/author by/IN/by George/NNP/george Orwell/NNP/orwell",
    // ListQuestion(QueryWithProperty(NamedQuery(List(Token("books", "NN", "book"))),
  ...
  test(
    "which/WDT/which instrument/NN/instrument did/VBD/do John/NNP/john Lennon/NNP/lennon play/VB/play",
  ...
  test(
    "Who/WP/who wrote/VBD/write \"/``/\" Le/NNP/le Petit/NNP/petit Prince/NNP/prince \"/''/\""
  ...
  test(
    "What/WP/what did/VBD/do George/NNP/george Orwell/NNP/orwell write/VB/write",
  ...
  test(
    "What/WP/what was/VBD/be authored/VBN/author by/IN/by George/NNP/george Orwell/NNP/orwell",
  ...
  test(
    "What/WP/what books/NNP/book were/VBD/be authored/VBN/author by/IN/by George/NNP/george Orwell/NNP/orwell",
  ...
  test(
    "authors/NNS/author who/WP/who died/VBD/die",
    // ListQuestion(QueryWithProperty(NamedQuery(List(Token("authors", "NNS", "author"))),
  ...
  test(
    "What/WDT/what actor/NN/actor married/VBD/marry"
  ...
  test(
    "Who/WP/who did/VBD/do Bill/NNP/bill Clinton/NNP/clinton 's/POS/'s daughter/NN/daughter marry/VB/marry",
  ...
  test(
    "Clinton/NNP/clinton 's/POS/'s children/NNS/child and/CC/and grandchildren/NNS/grandchild",
  ...
  test(
    "What/WP/what are/VBP/be the/DT/the population/NN/population"
  ...
  test(
    "the/DT/the population/NNP/population of/IN/of Japan/NNP/japan and/CC/and China/NNP/china",
    // ListQuestion(RelationshipQuery(NamedQuery(List(Token("the", "DT", "the"),
  ...
  test(
    "the/DT/the population/NNP/population and/CC/and area/NNP/area"
    ...
    { env =>
      ...
      val populationOfJapan = env
        .newNode()
        .in(japan, P.hasPopulation)

      val populationOfChina = env
        .newNode()
      ...
      List(populationOfJapan, populationOfChina, areaOfJapan, areaOfChina)
    },
    ("3",
     """
        |{ ?1  wdt:P1082   ?3 ;
  ...
  test(
    "the/DT/the population/NN/population ,/,/, land/NN/land area/NN/area and/CC/and capitals/NNP/capital of/IN/of"
    ...
    { env =>
      ...
      val capitalOfJapan = env
        .newNode()
        .in(japan, P.hasCapital)

      val capitalOfIndia = env
        .newNode()
        .in(india, P.hasCapital)

      val capitalOfChina = env
        .newNode()
        .in(china, P.hasCapital)

      List(populationOfJapan,
           populationOfIndia,
           populationOfChina,
           areaOfJapan,
           areaOfIndia,
  ...
  test(
    "Japan/NNP/japan and/CC/and China/NNP/china 's/POS/'s population/NNP/population and/CC/and area/NNP/area",
  ...
  test(
    "children/NNS/child and/CC/and grandchildren/NNS/grandchild of/IN/of Clinton/NNP/clinton",
    // ListQuestion(RelationshipQuery(AndQuery(List(NamedQuery(List(Token("children", "NNS", "child"))),
  ...
  test(
    "who/WP/who wrote/VBD/write books/NNS/book",
    // PersonListQuestion(PropertyWithFilter(List(Token("wrote", "VBD", "write")),
  ...
  test(
    "presidents/NNS/president that/WDT/that have/VBP/have children/NNS/child",
    // ListQuestion(QueryWithProperty(NamedQuery(List(Token("presidents", "NNS", "president"))),
  ...
  test(
    "what/WP/what are/VBP/be the/DT/the largest/JJS/large cities/NNS/city in/IN/in europe/NN/europe",
    // ListQuestion(QueryWithProperty(NamedQuery(List(Token("the", "DT", "the"),
    //     Token("largest", "JJS", "large"), Token("cities", "NNS", "city"))),
  ...
  test(
    "List/VB/list books/NNS/book by/IN/by George/NNP/george Orwell/NNP/orwell",
  ...
  test(
    "Which/WDT/which city/NN/city is/VBZ/be bigger/JJR/big than/IN/than New/NNP/new York/NNP/york City/NNP/city",
  ...
  test(
    "who/WP/who is/VBZ/be older/JJR/old than/IN/than Obama/NNP/obama",
  ...
  test(
    "which/WDT/which mountains/NNS/mountain are/VBP/be "
  ...
  test(
    "Which/WDT/which cities/NNS/city have/VBP/have more/JJR/more than/IN/than "
  ...
  test(
    "In/IN/in which/WDT/which californian/JJ/californian cities/NNS/city "
  ...
  test(
    s"who/WP/who is/VBD/be the/DT/the discoverer/NNS/discoverer of/IN/of Pluto/NNP/pluto", {
      env =>
        val pluto = env
          .newNode()
          .out(NameLabel, "Pluto")
  ...
  test(
    "who/WP/who discovered/VBD/discover the/DT/the most/JJS/most planets/NNS/planet",
  ...
  test(
    "who/WP/who are/VBP/be the/DT/the children/NNS/child of/IN/of Clinton/NNP/clinton 's/POS/'s spouse/NNS/spouse",
  ...
  test(
    "Which/WDT/which books/NNS/book were/VBD/be written/VBN/write by/IN/by Jane/NNP/jane Austen/NNP/austen",
    // ListQuestion(QueryWithProperty(NamedQuery(List(Token("books", "NNS", "book"))),
  ...
  test(
    "Which/WDT/which country/NN/country was/VBD/be Obama/NNP/obama born/VBN/bear in/IN/in",
  ...
  test(
    "Which/WDT/which year/NN/year was/VBD/be Obama/NNP/obama born/VBN/bear in/IN/in",
  ...
  test(
    s"What/WP/what are/VBP/be some/DT/some of/IN/of Seth/NNP/seth Gabel/NNP/gabel 's/POS/'s"
  ...
  test(
    "who/WP/who died/VBD/die in/IN/in Paris/NNP/paris", { env =>
      val person = env
        .newNode()
        .out(P.isA, Q.human)
  ...
  test(
    "who/WP/who died/VBD/die before/IN/before 1900/CD/1900", { env =>
      val person = env
        .newNode()
        .out(P.isA, Q.human)
  ...
  test(
    "who/WP/who died/VBD/die in/IN/in 1900/CD/1900", { env =>
      val person = env
        .newNode()
        .out(P.isA, Q.human)
